...
export default function FolderItem({ file = {}, showOptions, onOpen, onDelete }) {
    ...
    return(
        <>
            <div className="w-[330px] h-[225px] bg-[var(--color-textF)] cursor-pointer rounded-3xl border-2 border-[var(--color-textBorder)] flex flex-col items-center transition-transform duration-200 hover:scale-110"
                 onClick={handleClick}>
                <div className=" relative w-[270px] h-[60px] text-[var(--color-textP)] rounded-3xl flex flex-row items-center justify-between">
                ...
                <div className="bg-[var(--color-textP)] w-[270px] h-[135px] rounded-3xl relative overflow-hidden">
